...
def get_candles_historical(client, market):
    ...
    # Extract historical for each range (timeframe)
    for timeframe in ISO_TIMES.keys():
        ...
        # Get data
        # CAN MODIFY TO PRIVATE (testnet market is diff from mainnet market )
        candles = client.public.get_candles(
            market=market,
            resolution=RESOLUTION,
            from_iso=from_iso,
...
def construct_market_prices(client):
    ...
    # note (development) : can limit amount of pairs for testing
